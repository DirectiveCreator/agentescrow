            ...
            <div className="rounded-xl p-8" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { track: 'OpenServ: Ship Something Real', fit: 5, status: 'Integrated', desc: 'Agent #3973 with 6 capabilities. Full SDK integration for cross-agent collaboration. $4,500 pool.' },
                  { track: 'OpenServ: Best Build Story', fit: 5, status: 'Draft Ready', desc: 'Documented build log of our OpenServ integration journey. $500 pool (1st & 2nd: $250 each).' },
                  ...
                  { track: 'ENS Open Integration', fit: 4, status: 'Built', desc: 'Open-ended ENS integration for agent discovery. $300.' },
